...
<form action="<?php print(_APP_ROOT); ?>/app/calc.php" method="post" class="pure-form pure-form-stacked">
	...
	<fieldset>
		...
		<label for="id_l">Okres (miesiace) </label>
		<input id="id_l" type="text" name="l" value="<?php out($l) ?>" />
		<label for="id_o">oprocentowanie: </label>
		<input id="id_o" type="text" name="o" value="<?php out($o) ?>" />
	</fieldset>	
...
<br>
<?php echo 'Łącznie zapłacimy: '. 12*$result; ?>
</div>
<?php } ?>
